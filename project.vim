...
badd +0 db/migrate/20111222080821_add_password_to_users.rb
...
exe 'vert 2resize ' . ((&columns * 64 + 75) / 150)
exe 'vert 3resize ' . ((&columns * 53 + 75) / 150)
argglobal
enew
file NERD_tree_1
setlocal keymap=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 45 - ((26 * winheight(0) + 18) / 37)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 99 - ((15 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
99
