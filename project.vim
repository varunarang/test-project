...
badd +2 spec/models/user_spec.rb
silent! argdel *
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 14 - ((0 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
14
